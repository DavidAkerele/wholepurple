  ...
  return (
    <div className="flex flex-col gap-8">
      <div>
        ...
        <p className="text-gray-800 font-medium">Manage and fulfill pending harvests.</p>
      </div>

      <div className="bg-white rounded-[40px] border border-gray-100 shadow-xl shadow-purple-900/5 overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm">
            <thead className="bg-gray-50 text-gray-900 text-gray-800 uppercase font-black text-[10px] tracking-widest">
              <tr>
            ...
            <tbody className="divide-y divide-gray-100">
              {orders.map(order => (
                <tr key={order.id} className="hover:bg-gray-50 text-gray-900/50 transition-colors group">
                  <td className="px-10 py-6 font-mono text-xs text-gray-800">
                  ...
                  <td className="px-6 py-6 text-gray-800 font-medium">
              ...
              {orders.length === 0 && (
                <tr>
                  <td colSpan={5} className="px-6 py-12 text-center text-gray-800">No orders to fulfill.</td>
                </tr>
              )}
            </tbody>
          </table>
